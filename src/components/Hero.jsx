...
import PhoneImg1 from '@/images/phone-img1.jpg'
    ...
    <div {...props}>
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor="#26AEAB" />
            <stop offset="1" stopColor="#26AEAB" stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
      <svg
...
function AppDemo() {
  ...
  return (
    <AppScreen>
      <div className='p-4 bg-[#26AEAB] -mt-10'>
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              <AppStoreLink />
              {/* <PlayStoreLink /> */}
              <div className='rounded-xl bg-black p-2 cursor-pointer'>
                <a href="#">
                  <Image
                    src={PlayStore}
                    width={100}
